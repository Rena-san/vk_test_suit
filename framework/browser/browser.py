...
from project_vk.tests.config.browser import BrowserConfig
from project_vk.tests.config.waits import Waits
...
class Browser(metaclass=Singleton):
    ...
    def set_up_driver(self, browser_key=BrowserConfig.BROWSER, capabilities=None, is_incognito=True,
    ...
    def execute_script(self, script, arguments=None):
        Logger.info("Вызов метода  " + script)
