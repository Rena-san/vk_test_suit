...
from project_vk.tests.config.browser import BrowserConfig, Grid


class BrowserFactory:

    @staticmethod
    def get_browser_driver(capabilities=None, is_incognito=True, enable_performance_logging=False, test_name=None,
                           grid_port=None):
