...
from framework.waits.wait_for_absence_of_element import \
    WaitForAbsenceOfElementLocated
from framework.waits.wait_for_contains_class import WaitForContainsClass
from framework.waits.wait_present_with_custom_action import \
    WaitPresentWithCustomAction
